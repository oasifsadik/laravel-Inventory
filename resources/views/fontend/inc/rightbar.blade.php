<div class="sb-slidebar sb-right sb-style-overlay">
    ...
    <ul class="quick-chat-list">
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="{{ asset('fontend') }}/img/chat-avatar2.jpg" class="mr-3 rounded-circle">
                </a>
        ...
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="{{ asset('fontend') }}/img/chat-avatar.jpg" class="mr-3 rounded-circle">
                </a>
                <div class="media-body">
        ...
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="{{ asset('fontend') }}/img/pro-ac-1.png" class="mr-3 rounded-circle">
                </a>
                <div class="media-body">
                    <div class="media-status">
        ...
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="{{ asset('fontend') }}/img/avatar1.jpg" class="mr-3 rounded-circle">
                </a>
                <div class="media-body">
        ...
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="{{ asset('fontend') }}/img/mail-avatar.jpg" class="mr-3 rounded-circle">
                </a>
                <div class="media-body">
                    <div class="media-status">
